...
HydroPeak is a simple and easy to use standalone integration, it does not connect to any Hydro-Québec customer account and does not require a login. It only uses publicly available open data from Hydro-Québec, which keeps the setup simple and avoids sharing any personal information.
