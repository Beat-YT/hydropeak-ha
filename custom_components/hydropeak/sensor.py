...
class HydroPeakSensor(CoordinatorEntity, SensorEntity):
    ...
    def update_from_coordinator(self):
        ...
        if self.sensor_id == "event_start":
            ...
            duration = DEFAULT_ANCHOR_DURATION_PM if evenement.get("plageHoraire") == "PM" else DEFAULT_ANCHOR_DURATION_AM
            anchor_end = evenement["dateDebut"] - timedelta(minutes=DEFAULT_ANCHOR_OFFSET - duration)
